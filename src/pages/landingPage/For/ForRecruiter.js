...
export default function ForRecruiter() {
  ...
  return (
    <>
      <div className="bg-light pt-40 pb-8" style={{
          backgroundImage: "linear-gradient(rgba(255, 255, 255, 0.8), rgba(248, 229, 212, 0.6)), url('/img/cruiter-bg1.webp')",
        ...
        <div className="md:pt-0 mb-20 md:w-10/12 w-11/12 mx-auto text-center">
          ...
          <img
            ...
            src={companies}
          />
          <p className="text-2xl mx-auto md:w-8/12 w-12/12 pt-4 mb-12">
      ...
      <div className="pt-28">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-14 md:py-40 md:pb-12 py-12   md:text-left text-center md:w-10/12 w-11/12  mx-auto ">
          ...
          <div>
            ...
            <p className="text-xl font-light">
              Our <strong className="text-blue-500">Miverva</strong> community allows users to discover and apply for
              jobs.
            </p>
          </div>
      ...
      <FAQ
        ...
        questionThree="How do I get my company on Minerva?"
        answerThree="Contact hr@minervatc.in"
      />
      {type === "recruiter" ? (
        <Banner

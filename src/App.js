...
import ResumeService from "pages/landingPage/ResumeService";
    ...
    <SetPopupContext.Provider value={setPopup}>
      <Router>
        ...
        <Routes>          
          ...
          <Route exact path="/resume-service" element={<ResumeService />} />
          <Route exact path="/resume-service/resumeapplication" element={<Resumeapplication />} />

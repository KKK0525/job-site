      ...
      {type === "recruiter" ? (
        <>
          <h1 className="md:text-6xl text-4xl font-bold text-center text-gray-900 ">
            How <strong className="text-blue-500">Minerva</strong> works for <strong>Recruiter</strong>
          </h1>
          <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-14 md:py-40 md:pb-12 py-12   md:text-left text-center md:w-10/12 w-11/12  mx-auto ">
            ...
            <div>
              ...
              <p className="text-xl font-light">
                Our <strong className="text-blue-500">Minerva</strong> community allows users to discover and apply for
                jobs.
              </p>
            </div>
        ...
        <>
          <h1 className="md:text-6xl text-4xl font-bold text-center text-gray-900 ">
            How <strong className="text-blue-500">Minervar</strong> works for <strong>Applicants</strong>
          </h1>
        ...
        <Slide direction="right">
          <h1 className="md:text-6xl text-4xl font-bold text-center text-gray-900 ">
            How <strong style={{ WebkitTextFillColor: "#379202" }}>Minerva</strong> works
          </h1>
        </Slide>
          <div className="grid lg:grid-cols-3 grid-cols-1 gap-12 md:py-32 py-12  text-center md:w-10/12 w-11/12  mx-auto ">
          <Slide direction="down">
            <div className="flex flex-col items-center text-center">
              <VscAccount className="text-6xl mb-6  text-red-500" />
              <div className="text-gray-900 text-md tracking-wide pb-2 uppercase font-semibold">
                Step 1:
              </div>
              <h1 className="text-3xl text-gray-900 pb-3 font-semibold text-stone-700">
                Create account
              </h1>
          ...
          <Slide direction="up">
            <div className="flex flex-col items-center text-center">
              <BiLogInCircle className="text-6xl mb-6  text-yellow-500"/>
              <div className="text-gray-900 text-md tracking-wide pb-2 uppercase font-semibold">
                Step 2:
              </div>
              <h1 className="text-3xl text-gray-900 pb-3  font-semibold">
          ...
          <Slide direction="down">
            <div className="flex flex-col items-center text-center">
              <TbBrandKickstarter className="text-6xl mb-6 text-green-500"/>
              <div className="text-gray-900 text-md tracking-wide pb-2 uppercase font-semibold">
                Step 3:
              </div>
              <h1 className="text-3xl  text-gray-900 pb-3 font-semibold">
